...
class AllSongsScreen extends StatelessWidget {
  ...
  const AllSongsScreen({super.key, required this.playlistId});
  ...
  Future<void> _exportPdf(
    ...
    if (songs.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Playlist trống')));
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final songs = playlistProvider.getSongsOfPlaylist(playlistId);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Xuất PDF',
            onPressed: () => _exportPdf(context, playlist.name, songs),
          ),
        ],
      ),
      body: Column(
